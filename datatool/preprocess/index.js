...
program
    ...
    .command('qhs', 'halts statistic per district: node index.js qh < ../geojson/munich.geojson')
    .command('qhc', 'coordinates of halts per destrict: node index.js qhc < ../geojson/munich.geojson')
